...
CREATE TABLE `pacientes` (
  ...
  `sintoma_tos` char(2) NOT NULL,
  `sintoma_fiebre` char(2) NOT NULL,
  `sintoma_disnea` char(2) NOT NULL,
  `sintoma_dolormuscular` char(2) NOT NULL,
  `sintoma_gripe` char(2) NOT NULL,
  `sintoma_presionalta` char(2) NOT NULL,
  `sintoma_fatiga` char(2) NOT NULL,
  `sintoma_garraspera` char(2) NOT NULL,
